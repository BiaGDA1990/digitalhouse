...
console.log(
  `Acrescentado o aluno Rodrigo :${JSON.stringify(
    curso.listaEst[curso.listaEst.length - 1]
  )}`
)
console.log(
  '========================================================================'
...
console.log(
  `retrono da funcao avaliando a aprovacao de cada aluno :${curso.avaliaAlunos(
    curso
  )}`
)
console.log(
